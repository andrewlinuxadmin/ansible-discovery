# Testes Unitários - process_facts Module

Este diretório contém testes unitários para o módulo customizado `process_facts.py`.

## Estrutura

- `test_process_facts.py` - Testes unitários principais
- `run_tests.sh` - Script para executar os testes automaticamente
- `.flake8` - Configuração do flake8 para ignorar regras específicas dos testes
